      ...
      <div className="max-w-3xl mx-auto bg-white p-8 shadow-md rounded-lg">
        ...
        <section className="mb-8">
          ...
          <div className="text-gray-600">
            <p className="text-lg text-gray-700">1. Общие положения</p>
            <p className="mt-2">
            ...
            <p className="mt-2">
              ...
              веб-сайта https://liscaffee.netlify.app/.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          <div className="text-gray-600">
            ...
            <p className="mt-2">3.1. Оператор имеет право:</p>
              ...
              <table className="table-auto w-full border-collapse border border-gray-200">
                <thead className="bg-gray-100">
                  <tr className="border border-gray-200">
                    <th className="px-4 py-2 text-left">Цель обработки</th>
                    <th className="px-4 py-2 text-left">Персональные данные</th>
                    <th className="px-4 py-2 text-left">Правовые основания</th>
                    <th className="px-4 py-2 text-left">Виды обработки</th>
                  </tr>
                </thead>
        ...
        <div className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              ...
              Оператора{" "}
              <a
                href="mailto:lesha1zmailov@yandex.ru"
                className="text-blue-600"
              >
                lesha1zmailov@yandex.ru
              </a>{" "}
              с пометкой «Актуализация персональных данных».
            </li>
            <li>
              8.4. Срок обработки персональных данных является неограниченным.
            ...
            <li>
              ...
              Политикой конфиденциальности. Субъект персональных данных
              ознакомлен с указанными документами. Оператор не несет
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">
            ...
            <a href="mailto:lesha1zmailov@yandex.ru" className="text-blue-600">
              lesha1zmailov@yandex.ru
            </a>
          ...
          <p className="mb-4">
            ...
            <a
              href="https://liscaffee.netlify.app/personal"
              className="text-blue-600"
            >
              https://liscaffee.netlify.app/personal
            </a>
